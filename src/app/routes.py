...
ROUTES = [
  ...
  ###
  # The following views can be enabled to delete blobstore -> GCS mapping
  # entities as well as all blobstore blobs.
  #
  # NOTE: These views must be used with caution as they will permanently
  # destroy data!!!
  ###
